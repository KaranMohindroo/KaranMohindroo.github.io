...
var football;
var text;
var hackerrank_url = "https://www.hackerrank.com/KaranMohindroo";
var hackerearth_url = "https://www.hackerearth.com/@karanmohindroo";
var codechef_url = "https://www.codechef.com/users/karan_014";
var github_url = "https://github.com/KaranMohindroo";
var facebook_url = "https://www.facebook.com/karan.mohindroo.9";
var linkedin_url = "https://www.linkedin.com/in/karanmohindroo/";
var resume_url = "https://drive.google.com/open?id=1EYkjNObOr0RxLuvD9qMVB8c7qQOp9hcw";
var website_url = "http://karanmohindroo.github.io";
var gmail_url = "mailto:karanmohindroo14@gmail.com";
var inst_text;
var bug;
var bug_tween;
...
function preload() {
    ...
    game.load.image('school', 'assets/school1.png');
    game.load.image('mainbanner', 'assets/interactive-resume2.png');
    game.load.image('building', 'assets/building1.png');
    ...
    game.load.atlasJSONHash('karan', 'assets/robby-slides.png', 'assets/hero_running.json');
    ...
    game.load.image('nit', 'assets/nit.png');
    ...
    game.load.image('sandiskPd', 'assets/samsung.png');
    game.load.image('samsung', 'assets/samsung.png');
    game.load.image('hackerearthLogo', 'assets/hackerearthlogo.png');
    game.load.image('instaLogo', 'assets/instalabs.png');
    game.load.image('iirs', 'assets/iirs.png');
    game.load.image('campk12Logo', 'assets/iirs.png');
    game.load.image('amazon','assets/amazon.svg');
    ...
    game.load.image('bicep', 'assets/bicep.gif');
    game.load.image('bicep1', 'assets/bicep1.gif');
    ...
    game.load.image('icpc', 'assets/snackdown.png');
...
function create() {
    ...
    */
    ...
    //Add Mountain
    hill1 = game.add.sprite(2700, h - 300 + 400, 'hill');

    hill2 = game.add.sprite(3100, h - 350 + 400, 'hill');

    hill3 = game.add.sprite(4300, h - 400 + 400, 'hill');



    //Add Coco Trees
    //ct1  = game.add.sprite(5000,h,'cocotree');
    ct2 = game.add.sprite(5800, h, 'cocotree');
    //ct3  = game.add.sprite(5400,h,'cocotree');
    ct4 = game.add.sprite(6000, h, 'cocotree');
    ...
    pythontext = game.add.text(5850, h - 360, 'Java\n', style_white2);
    //	jstext = game.add.text(5430,h-450-50,'JavaScript\n 98.48%',style_white2);
    ctext = game.add.text(6060, h - 440, 'C/C++ \n', style_white2);
    ...
    */
    ...
    codetext = game.add.text(6350, h - 550, 'Missiles Unlocked', mustard_style);
    game.add.text(6350, h - 455, 'Blast          to ', mustard_style);
    game.add.text(6350, h - 340, 'unlock skills', mustard_style);
    ...
    */
    ...
    game.add.sprite(xcoord + 80, h - 450, 'questionbrick');
    //	game.add.sprite(xcoord+2*119,h-450,'squarebrick');

    var exp_index = 0;
    for (xcoord = 7100; xcoord <= 7962; xcoord += 2 * 119) {
        game.add.sprite(xcoord, h - 450, 'squarebrick');
    ...
    game.add.text(3020, h - 250, "Class 10th \n 9.2/10.0 CGPA ", style);
    game.add.text(3430, h - 280, "Class 12th \n 92.8 % marks ", style);
    ...
    var brick2 = game.add.sprite(12450 - 70, h - 100 - 36, 'brick');
    brick2.scale.setTo(0.5, 0.5);
    game.add.sprite(12450 - 70, h - 100, 'brick').scale.setTo(0.5, 0.5);


    game.add.sprite(12450 + 350, h - 100 - 36, 'brick').scale.setTo(0.5, 0.5);
    game.add.sprite(12450 + 350, h - 100, 'brick').scale.setTo(0.5, 0.5);
    //game.add.sprite(12650,h-400,'treeS').alpha=0.8;
    game.add.sprite(12550, h - 300, 'treeS').scale.setTo(0.75, 0.75);
    ...
    var banner = game.add.sprite(220, h - 300 - 235, 'mainbanner');
    ...
    game.add.sprite(5200, h - 440, 'level');
    game.add.text(5270, h - 340, "Level 2");
    game.add.text(5340, h - 260, "Skills > >");
    ...
    game.add.sprite(base6 - 550, h - 440, 'level');
    game.add.text(base6 - 470, h - 340, "Level 6");
    game.add.text(base6 - 430, h - 260, "Other Highlights", {
    ...
    game.add.sprite(10400, h - 385, 'frog');
    game.add.sprite(10950,h-485,'frog').scale.setTo(1.3,1.3);

    //Add logos
    game.add.sprite(10405, h - 250, 'iirs').scale.setTo(0.48, 0.48);
    game.add.sprite(10960,h-270,'amazon').scale.setTo(0.15,0.15);
    ...
    game.add.text(10470, h - 240, "IIRS,ISRO\n June-July 2018 \nIntern\n(Software Developer)", style_ex);
    game.add.text(11080,h-290,"Amazon IDC\nBangalore \n June 2019 - Present \n Software Developer",style_exL);

    //var pd = game.add.sprite(10875,h-320,'sandiskPd');
    //	pd.scale.setTo(0.9,0.9);
    //pd.angle = -0;

    //Add projects
    game.add.sprite(13200, h - 390, 'games');
    game.add.text(13200, h - 540, "\tDeveloped \nOPEN SOURCE TOOL \nFOR SATELLITE IMAGE PROCESSING\nIt classifies the area into different classes\nlike Agriculture,Forests,etc.", style_white);

    //game.add.sprite(13760,h-260,'gamershq');
    //game.add.text(13750,h-380,"Developed a gaming portal \n with frontend & backend \n to host and play games",style_white);


    game.add.sprite(14400, h - 210, 'harddrive').scale.setTo(0.6, 0.6);
    game.add.sprite(14400, h - 310, 'bits');
    game.add.text(14380, h - 440, "Developed \nFILE SEARCH ENGINE\nA Java project used \n to search files.", style_white);
    /*
    ...
    */
    ...
    /*	cup1 = game.add.sprite(base5+820+200,-280,'cup');
    	...
    	*/
    cup2 = game.add.sprite(base5 + 1000, -340, 'cup');
    //cup2.scale.setTo(0.8,0.8);

    game.add.sprite(base5 + 1280, h - 410, 'csi');
    game.add.text(base5 + 1220, h - 250, "1st in Techno-Crackers\nCoding Challenge", style_position);
...
*/
    ...
    */
    ...
    cup3 = game.add.sprite(base5 + 1570, -410, 'cup');
    game.add.sprite(base5 + 1770, h - 270, 'icpc');
    game.add.text(base5 + 1800, h - 380, "Secured 244th rank\n in SnackDown 2017 !", {
        font: "30px Arial",
        fill: "#fff",
        align: "center"
    });
    ...
    */
    ...
    game.add.sprite(base6 + 1800 - 30, h - 500, 'tree1');
    game.add.sprite(base6 + 1850 + 30, h - 400, 'treeS');
    mustard_style = {
        font: "80px Roboto",
        fill: "#000",
        align: "center"
    };
    game.add.text(base6 + 750, h - 600, "Fitness Enthusiast", mustard_style);
    bot1 = game.add.sprite(base6 + 600, h - 450, 'bicep');
    bot1.animations.add('run');
    bot1.animations.play('run', 15, true);
    bot = game.add.sprite(base6 + 1000, h - 450, 'bicep1'); //.scale.setTo(1,0.92);
    bot.animations.add('run');
    bot.animations.play('run', 15, true);
    //   bot.animations.play('run', Phaser.Animation.generateFrameNames('bicep1', 0, 24, '', 4),15, true);
    ...
    game.add.text(base7 + 650, h - 550 + 20, "Website", {
        font: "40px Arial",
        fill: "#fff"
    });
    ...
    game.add.sprite(base7 + 850, h - 430, 'cloud').scale.setTo(2.3, 1.3);
    button_hackerrank = game.add.button(base7 + 890, h - 400, 'hackerrank', openHackerrank, this);
    ...
    */
    ...
    game.add.text(4600, h - 340, "  B.Tech.\n(2015-2019)\nComputer Science\n77% marks", style_roboto);
    ...
    //Add hero 
    hero = game.add.sprite(100, -200, 'karan');
...
*/
    octopus2 = game.add.sprite(12800, h - 200, 'seacreatures');
    ...
    crab2 = game.add.sprite(12350, h - 180, 'seacreatures');
...
*/
    ...
    var clg = game.add.sprite(3800, h - 590, 'nit');
...
function collisionHandler(bullet, tile) {
    ...
    if (explosion_count == 1) {
        ...
        var andro = game.add.sprite(bv + 3 * inc, h - 500, 'android');
...
function update() {
    ...
    // game.physics.arcade.overlap(bullets, practice, collisionHandler, null, this);
    var scroll = game.input.mouse.wheelDelta;

    if (hero.x >= 2000 && hero.x <= 2450) {
        moveHillsUp();
    }
    if (hero.x >= 2000 && hero.x <= 2750) {
        moveHillsUp1();
    }
    if (hero.x > 3000 && hero.x <= 4050) {
        moveHillsUp2();
    }
// Movement speed control
    ...
    */
    ...
    if (hero.x >= 12200 && hero.x <= 12350 && (forwardButtonPressed())) {
        var t = game.add.tween(hero).to({
            x: 12500,
            y: h - 700
        }, 100);
    ...
    if (hero.x >= 12700 && hero.x <= 12800 && (backButtonPressed())) {
        var t = game.add.tween(hero).to({
            x: 12100,
            y: h - 600
        }, 100);
...
*/
    ...
    /*	if(hero.x>6100 && hero.x <=6500 && hero.y>= h-245-hero.height-50 && direction!='left'){
    		game.add.tween(hero).to({x:6500,y:h-653},100).start();
	...
	*/
    ...
    /*	if(hero.x <=7000&&hero.x>6830 && direction=="left" ){
    		hero.y = h - 650;
